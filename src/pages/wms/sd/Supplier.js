...
export default function Biz(props) {
  ...
  const fnSearch = () => {
    ...
    client.post(`/wms/sd/supplier/selectSupplierList`, data, {})
      .then(res => {
  ...
  function onClickSave(){
    ...
    openModal(MyModal, {
      ...
      onSubmit: () => {
        //메뉴리스트 저장
        client.post(`/wms/sd/supplier/saveSupplier`,rowData, {})
          .then(res => {
            alert('저장되었습니다.');
            fnSearch();
          }).catch(error => { 
  ...
  function onClickDel(){
    ...
    openModal(MyModal, {
      ...
      onSubmit: () => {
        //메뉴리스트 저장
        client.post(`/wms/sd/supplier/deleteSupplier`,rowData,{})
          .then(res => {
            alert('삭제되었습니다.')
            fnSearch();
          }).catch(error => { 
