...
## 툴
### Flutter
- 다운로드 URL : [https://flutter-ko.dev/docs/get-started/install/windows](https://flutter-ko.dev/docs/get-started/install/windows)
- 환경변수 세팅하기 :
...
### Android Studio
- 다운로드 URL : [https://developer.android.com/studio](https://developer.android.com/studio)
...
```
사진과 같은 결과가 나올 것이다.
[![install](/assets/imgs/flutter-basic/2021-04-07-1-img-install.png)](/assets/imgs/flutter-basic/2021-04-07-1-img-install.png)
...
## FloatingActtionButton 
플로팅 액션 버튼. 화면 우측하단에 있어 누르면 활용가능한 여러 다른 버튼들이 나오는 것.

[![install](/assets/imgs/flutter-basic/2021-04-07-9-floatingactionbutton.png)](/assets/imgs/flutter-basic/2021-04-07-9-floatingactionbutton.png)
...
- 글 쓰는 페이지나, 수정 등등의 창이 길어질때, 정해진 사이즈내에서 해결이 안되고 스크롤이 생길 수 있는데, 스크롤 기능을 안넣으면 짤릴수있다. 그래서 넣어놓으면 좋은기능.
...
## image_picker
- url : [https://pub.dev/packages/image_picker/versions/0.7.4](https://pub.dev/packages/image_picker/versions/0.7.4)
...
## Login
- url : [https://pub.dev/packages/flutter_signin_button](https://pub.dev/packages/flutter_signin_button)
...
1. Flutter 프로젝트 실행
   ...
   - [![install](/assets/imgs/flutter-basic/2021-04-07-3-flutter-application.png)](/assets/imgs/flutter-basic/2021-04-07-3-flutter-application.png)
   - ```Flutter SDK Path``` 경로가 아까 다운받은 경로로 설정되어있는지 확인
   - [![install](/assets/imgs/flutter-basic/2021-04-07-4-flutter-sdk-path.png)](/assets/imgs/flutter-basic/2021-04-07-4-flutter-sdk-path.png)
   - 프로젝트 위치 설정
   - [![install](/assets/imgs/flutter-basic/2021-04-07-5-application-name.png)](/assets/imgs/flutter-basic/2021-04-07-5-application-name.png)
   - 완료
  
2. Device 설치
Android Studio 에서 개발하기 위해서 핸드폰과 같은 ```가상 Device```를 띄워 테스트를 할 수 있다.
   - [AVD Manager] - [원하는 기기 설치 및 클릭] - [Device 선택] - [실행]
   - [![install](/assets/imgs/flutter-basic/2021-04-07-6-findavdmanager.png)](/assets/imgs/flutter-basic/2021-04-07-6-findavdmanager.png)
   - 아래에서 설치한 Device 를 찾아 선택하면 Device가 실행된다. 
   - [![install](/assets/imgs/flutter-basic/2021-04-07-7-finddevice.png)](/assets/imgs/flutter-basic/2021-04-07-7-finddevice.png)
   - Device 실행 확인
   - [![install](/assets/imgs/flutter-basic/2021-04-07-8-checkDevice.png)](/assets/imgs/flutter-basic/2021-04-07-8-checkDevice.png)
